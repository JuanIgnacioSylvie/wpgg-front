...
///
/// En **web**, el flujo debe usar [buildRiotRsoSignInAbsoluteUrl] y navegación de
/// documento (`window.location`), no `fetch`/XHR, para que un **302** del API hacia
/// Riot `/authorize` lo siga el navegador sin CORS.
library;
...
String buildRiotRsoSignInAbsoluteUrl(
  ...
  return Uri.parse('$base/riot/rso/sign-in')
      .replace(
